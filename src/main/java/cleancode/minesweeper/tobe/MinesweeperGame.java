...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // 추상화 레벨을 맞춘다. 기능을 나눈다는 개념보다는 이 작업은 뭘 하는거지~ 에 대한 추상화가 필요함
            // 처음 보는 사람이 이게 뭘까? 라는 생각이 들면 추상화를 시키는게 맞음
    ...
    private static int convertColFrom(char cellInputCol) {
        switch (cellInputCol) {
            case 'a':
                return 0; case 'b': return 1; case 'c': return 2; case 'd': return 3; case 'e': return 4; case 'f': return 5; case 'g': return 6; case 'h': return 7; case 'i': return 8; case 'j': return 9; default: return -1;
        }
    }
